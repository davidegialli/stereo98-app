class AppThemes {
  ...
  /// Ritorna true se il tema è chiaro
  static bool isLight(int themeId) {
    return themeId == chiaro || themeId == rosaCipria || themeId == azzurroCielo;
  }

  /// Tutti i temi scuri disponibili (per la selezione in Automatico)
  static const List<int> darkThemes = [scuro, vivace, bluNotte, amaranto, grafite];

  /// Tutti i temi chiari disponibili
  static const List<int> lightThemes = [chiaro, rosaCipria, azzurroCielo];
