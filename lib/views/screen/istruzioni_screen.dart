...
class IstruzioniScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            _buildSection(context, icon: Icons.music_note, title: '1. Ascoltare la Radio', items: [
            ...
            _buildSection(context, icon: Icons.nightlight_round, title: '2. Sleep Timer', items: [
            ...
            _buildSection(context, icon: Icons.star, title: '3. Mi Piace — Vota il Brano', items: [
            ...
            _buildSection(context, icon: Icons.library_music, title: '4. Le Mie Canzoni', items: [
            ...
            _buildSection(context, icon: Icons.emoji_events, title: '5. Il Tuo Codice Fan', items: [
            ...
            _buildSection(context, icon: Icons.history, title: '6. Hai Ascoltato', items: [
            ...
            _buildSection(context, icon: Icons.poll, title: '7. Sondaggi', items: [
              'Apri il menu laterale (☰ in alto a sinistra)',
              'Tocca 📊 Sondaggi',
            ...
            _buildSection(context, icon: Icons.mail_outline, title: '8. Contattaci', items: [
              'Apri il menu laterale (☰ in alto a sinistra)',
              'Tocca 📨 Contattaci',
            ...
            _buildSection(context, icon: Icons.calendar_today, title: '9. Palinsesto e Programmi Preferiti', items: [
            ...
            _buildSection(context, icon: Icons.mic, title: '10. Shows', items: [
              'Apri il menu laterale e tocca Shows',
              'Sfoglia tutti i programmi della radio',
              'Ogni show ha la sua descrizione e immagine',
            ]),
            _buildSection(context, icon: Icons.podcasts, title: '11. Podcast', items: [
            ...
            _buildSection(context, icon: Icons.settings, title: '12. Impostazioni', items: [
              'Tema — Scegli tra 9 temi (Chiari, Scuri o Automatico)',
            ...
            _buildSection(context, icon: Icons.notifications, title: '13. Notifiche', items: [
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: context.s98TextFaint, fontSize: 12),
                    textAlign: TextAlign.center,
                  ),
                ],
              ),
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: context.s98SectionGradient,
        ),
  ...
  Widget _buildFaqSection(BuildContext context) {
    final faqs = [
      {'q': 'La radio non parte, cosa faccio?', 'a': 'Verifica la tua connessione internet (WiFi o dati mobili). Lo streaming richiede una connessione attiva. Prova a chiudere e riaprire l\'app.'},
      {'q': 'Posso ascoltare con gli auricolari Bluetooth?', 'a': 'Sì! L\'app supporta tutti i dispositivi Bluetooth. Collega i tuoi auricolari e premi Play.'},
      {'q': 'L\'app consuma molti dati?', 'a': 'Dipende dalla qualità scelta nelle Impostazioni: circa 60 MB/ora a 128 kbps, 100 MB/ora a 256 kbps e 140 MB/ora a 320 kbps. Consigliamo l\'uso del WiFi per un ascolto prolungato.'},
      {'q': 'Ho cambiato telefono, il mio codice fan è cambiato?', 'a': 'Sì, il codice fan è legato al dispositivo. Se cambi telefono riceverai un nuovo codice. Contattaci tramite "Scrivici" se hai bisogno di assistenza.'},
      {'q': 'Come trovo le canzoni che ho votato?', 'a': 'Apri il menu laterale e tocca "Le Mie Canzoni". Troverai tutte le canzoni a cui hai dato la stella, con la possibilità di ascoltarle su Apple Music.'},
      {'q': 'Come ricevo la notifica per un programma?', 'a': 'Vai nel Palinsesto e tocca il cuore accanto al programma che ti interessa. Riceverai automaticamente una notifica prima dell\'inizio. Puoi scegliere quanto tempo prima nelle Impostazioni.'},
      {'q': 'Come posso lasciare una recensione?', 'a': 'Apri il menu laterale e tocca "Valutaci". Verrai portato direttamente alla pagina dello store per lasciare la tua recensione. Ogni stella conta! ⭐'},
    ];
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.help_outline, color: Color(0xFFD85D9D), size: 22),
              const SizedBox(width: 10),
              Text(
                'Domande Frequenti',
                style: TextStyle(
